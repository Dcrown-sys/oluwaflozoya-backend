...
const { v4: uuidv4 } = require('uuid'); // to generate unique tx_ref
...
exports.createPendingDelivery = async (req, res) => {
  try {
    ...
    // ✅ Generate unique tx_ref for frontend to initialize Flutterwave
    ...
    // ✅ Insert payment record in payments table (pending)
    await sql`
    ...
    res.json({
      ...
      data: {
        ...delivery,
        tx_ref, // frontend will use this to initialize Flutterwave
      },
    });
  } catch (err) {
