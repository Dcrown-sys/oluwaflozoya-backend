...
router.post('/add-product', verifyAdmin, upload.array('images', 10), adminController.addProduct);
router.put('/products/:id', adminController.updateProduct);
router.delete('/products/:id', adminController.deleteProduct);
router.get('/locations', verifyAdmin, adminController.getAllLocations);
router.delete('/producers/:id',  adminController.deleteProducer);
...
// router.post('/buyer/confirm-payment', adminController.confirmPayment);
...
// ============================
 ...
 // Note: This might need a separate producers router if not here // GET /api/categories/:categoryId/producers
...
router.patch("/deliver", verifyCourier, adminController.markOrderDelivered);
router.post("/delivery/pickup/:delivery_id", verifyCourier, adminController.pickupOrder);
router.get('/deliveries', verifyCourier, adminController.getMyDeliveries);
